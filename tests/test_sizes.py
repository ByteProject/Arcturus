...
CEILINGS = {
    ...
    "features/pathfinding.storyarc": 18928,  # 2026-08-08 repriced: the silent-turn prompt rule (a turn that prints nothing goes straight to the next prompt; par_flush raises `spoke`, the prompt consumes it; the if-forum field report)
