...
CEILINGS = {
    "features/yes-no.storyarc": 18588,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/press-any-key.storyarc": 19216,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/shiftable.storyarc": 18724,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/enhance-redefine.storyarc": 19096,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/consult-about.storyarc": 19224,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/session-verbs.storyarc": 18912,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/vary.storyarc": 20084,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/foresight.storyarc": 19964,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/beyond.storyarc": 20840,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/alter.storyarc": 19436,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/catalogs.storyarc": 19376,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/matrix.storyarc": 19732,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/direction-grammar.storyarc": 18772,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/scenery-contents.storyarc": 19296,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/nautical.storyarc": 19232,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    ...
    "brass-lantern.storyarc": 20016,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "cloak-of-darkness.storyarc": 21040,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    ...
    "features/computed-properties.storyarc": 18472,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/containers.storyarc": 18772,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/daemons-and-timers.storyarc": 20068,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/doors-and-locks.storyarc": 18384,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/appearance.storyarc": 19152,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/components.storyarc": 18576,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/perform.storyarc": 18640,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/grains.storyarc": 18532,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/handlers.storyarc": 19616,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/grammar.storyarc": 18764,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/introproperty.storyarc": 19700,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/kinds-and-inheritance.storyarc": 18436,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/on-other.storyarc": 18320,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/zcolor.storyarc": 18712,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/scoring.storyarc": 20688,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/spans.storyarc": 18504,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "features/vehicles.storyarc": 19048,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/ambience.storyarc": 20484,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/conversations.storyarc": 20140,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/extended-verbs.storyarc": 21424,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/infocom-interrogation.storyarc": 20652,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/quotes.storyarc": 18712,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/take-all.storyarc": 20376,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/plurals.storyarc": 19312,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/statusline.storyarc": 18444,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    "granules/verbose-exits.storyarc": 18712,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
}
