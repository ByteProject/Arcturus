...
CEILINGS = {
    "features/yes-no.storyarc": 17536,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/press-any-key.storyarc": 18384,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/shiftable.storyarc": 17896,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/enhance-redefine.storyarc": 18216,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/consult-about.storyarc": 18372,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/session-verbs.storyarc": 17976,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/vary.storyarc": 19152,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/foresight.storyarc": 19504,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/beyond.storyarc": 19936,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/alter.storyarc": 18628,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/catalogs.storyarc": 18504,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/matrix.storyarc": 18816,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/direction-grammar.storyarc": 17928,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/scenery-contents.storyarc": 18476,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/trigger.storyarc": 17512,
    "features/adjectives.storyarc": 18092,  # 2026-08-15 first pin: the adjective marker showcase (>red, the ZIL match classes; games without the marker stay byte-identical)  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "granules/nautical.storyarc": 18416,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/npcengine.storyarc": 20464,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/maniacswap.storyarc": 18680,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "beispiel-deutsch.storyarc": 26116,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "brass-lantern.storyarc": 19240,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "cloak-of-darkness.storyarc": 20020,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "ejemplo-espanol.storyarc": 22864,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/computed-properties.storyarc": 17596,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/containers.storyarc": 17992,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/daemons-and-timers.storyarc": 19160,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/doors-and-locks.storyarc": 17744,  # 2026-08-17 repriced: the existence form (docs/01 chapter 3); a two-sided door is now present on both sides (~264 bytes of presence walk, the two language examples also pay the 1-byte both-forms marker)
    "features/appearance.storyarc": 18332,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/components.storyarc": 17812,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/whistle.storyarc": 17300,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/pathfinding.storyarc": 20200,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/perform.storyarc": 17604,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/grains.storyarc": 17424,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/handlers.storyarc": 18744,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/grammar.storyarc": 17636,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/introproperty.storyarc": 18904,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/kinds-and-inheritance.storyarc": 17564,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/on-other.storyarc": 17456,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/zcolor.storyarc": 17888,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/scoring.storyarc": 19764,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/spans.storyarc": 17680,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/vehicles.storyarc": 18236,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/text-slot.storyarc": 18612,  # 2026-08-31 repriced: the class refusals (relaxed pass + msg_wrong_class)
    "granules/carryweight.storyarc": 18236,  # 2026-08-30 new: the weight-budget showcase
    "granules/ambience.storyarc": 19492,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/conversations.storyarc": 19200,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/extended-verbs.storyarc": 20564,  # 2026-08-22 repriced: pour/spill bind fill through a reversed prepositional line, and the packs carry the role swap (+44; only games with such a line pay)
    "granules/infocom-interrogation.storyarc": 19380,  # 2026-08-11 repriced: the combined room listing (one sentence for plain items, Cosmos 1.5.0; the adopters' request)
    "granules/quotes.storyarc": 17652,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/take-all.storyarc": 19608,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/plurals.storyarc": 18480,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/statusline.storyarc": 17624,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/verbose-exits.storyarc": 17600,  # 2026-08-11 repriced: the combined room listing (one sentence for plain items, Cosmos 1.5.0; the adopters' request)
}
...
CLOAK_Z8_CEILING = 20656  # 2026-08-31 repriced: the class_fault tail global (z8 pads wider)
