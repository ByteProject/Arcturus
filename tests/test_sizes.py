...
CEILINGS = {
    ...
    "brass-lantern.storyarc": 19984,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
    ...
    "features/grains.storyarc": 18500,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
    ...
    "features/scoring.storyarc": 20656,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
    ...
    "granules/take-all.storyarc": 20344,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
    "granules/plurals.storyarc": 19280,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
