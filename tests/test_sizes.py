...
CEILINGS = {
    "features/yes-no.storyarc": 17856,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/press-any-key.storyarc": 18476,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/shiftable.storyarc": 18012,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/enhance-redefine.storyarc": 18356,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/consult-about.storyarc": 18500,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/session-verbs.storyarc": 18104,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/vary.storyarc": 19280,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/foresight.storyarc": 19248,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/beyond.storyarc": 20040,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/alter.storyarc": 18660,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/catalogs.storyarc": 18640,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/matrix.storyarc": 18936,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/direction-grammar.storyarc": 18032,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/scenery-contents.storyarc": 18528,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/nautical.storyarc": 18524,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    ...
    "features/doors-and-locks.storyarc": 17688,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/appearance.storyarc": 18432,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/components.storyarc": 17908,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/perform.storyarc": 17928,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/grains.storyarc": 17820,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/handlers.storyarc": 18860,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/grammar.storyarc": 18032,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/introproperty.storyarc": 18932,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/kinds-and-inheritance.storyarc": 17740,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/on-other.storyarc": 17628,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/zcolor.storyarc": 17988,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/scoring.storyarc": 19904,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/spans.storyarc": 17864,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "features/vehicles.storyarc": 18280,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/ambience.storyarc": 19676,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/conversations.storyarc": 19364,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/extended-verbs.storyarc": 20544,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/infocom-interrogation.storyarc": 19804,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/quotes.storyarc": 17988,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/take-all.storyarc": 19600,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/plurals.storyarc": 18608,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/statusline.storyarc": 17728,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
    "granules/verbose-exits.storyarc": 18012,  # 2026-07-30 repriced DOWN: the shared par_flush routine and the print_ret peephole (the win locked in)
}
