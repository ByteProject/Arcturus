...
CEILINGS = {
    ...
    "features/foresight.storyarc": 18728,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    ...
    "beispiel-deutsch.storyarc": 25184,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    ...
    "ejemplo-espanol.storyarc": 22232,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    ...
    "features/doors-and-locks.storyarc": 17200,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    ...
    "features/pathfinding.storyarc": 19592,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
