...
CEILINGS = {
    ...
    "features/foresight.storyarc": 19904,  # 2026-07-29 repriced DOWN: the exact-objective abbreviation optimizer and the DP encoder parse (the win locked in)
    ...
    "beispiel-deutsch.storyarc": 24960,  # 2026-07-29 repriced: phrase_named tests the grain flag (out-of-scope scenery words answer can-t-see, not the ask)
    ...
    "features/containers.storyarc": 18712,  # 2026-07-29 repriced DOWN: the exact-objective abbreviation optimizer and the DP encoder parse (the win locked in)
    ...
    "features/appearance.storyarc": 19092,  # 2026-07-29 repriced DOWN: the exact-objective abbreviation optimizer and the DP encoder parse (the win locked in)
    "features/components.storyarc": 18512,  # 2026-07-29 repriced DOWN: the exact-objective abbreviation optimizer and the DP encoder parse (the win locked in)
    ...
    "features/scoring.storyarc": 20620,  # 2026-07-29 repriced DOWN: the exact-objective abbreviation optimizer and the DP encoder parse (the win locked in)
    "features/spans.storyarc": 18448,  # 2026-07-29 repriced DOWN: the exact-objective abbreviation optimizer and the DP encoder parse (the win locked in)
