...
CEILINGS = {
    "features/yes-no.storyarc": 16916,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/press-any-key.storyarc": 17536,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/shiftable.storyarc": 17056,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/enhance-redefine.storyarc": 17412,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/consult-about.storyarc": 17536,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/session-verbs.storyarc": 17140,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/vary.storyarc": 18320,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/foresight.storyarc": 18220,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/beyond.storyarc": 19016,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/alter.storyarc": 17708,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/catalogs.storyarc": 17660,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/matrix.storyarc": 17972,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/direction-grammar.storyarc": 17092,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/scenery-contents.storyarc": 17560,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/nautical.storyarc": 17576,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    ...
    "beispiel-deutsch.storyarc": 23108,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "brass-lantern.storyarc": 18232,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "cloak-of-darkness.storyarc": 19088,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "ejemplo-espanol.storyarc": 21812,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/computed-properties.storyarc": 16820,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/containers.storyarc": 17140,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/daemons-and-timers.storyarc": 18368,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/doors-and-locks.storyarc": 16704,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/appearance.storyarc": 17480,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/components.storyarc": 16964,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/perform.storyarc": 16984,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/grains.storyarc": 16872,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/handlers.storyarc": 17900,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/grammar.storyarc": 17084,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/introproperty.storyarc": 17980,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/kinds-and-inheritance.storyarc": 16784,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/on-other.storyarc": 16684,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/zcolor.storyarc": 17048,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/scoring.storyarc": 18908,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/spans.storyarc": 16908,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "features/vehicles.storyarc": 17328,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/ambience.storyarc": 18652,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/conversations.storyarc": 18356,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/extended-verbs.storyarc": 19676,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/infocom-interrogation.storyarc": 18836,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/quotes.storyarc": 17024,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/take-all.storyarc": 18584,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/plurals.storyarc": 17600,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/statusline.storyarc": 16784,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
    "granules/verbose-exits.storyarc": 17052,  # 2026-08-01 repriced: the undo handshake (Flags 2 bit 4 read at boot, the -1 latch at the checkpoint, the truthful unavailable message and the gated death prompt; the Canopus and Haumea field reports)
}
...
CLOAK_Z8_CEILING = 21672  # 2026-07-28 repriced: grammar parity
