...
CEILINGS = {
    "features/beyond.storyarc": 18652,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/alter.storyarc": 17280,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/catalogs.storyarc": 17232,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/matrix.storyarc": 17596,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/direction-grammar.storyarc": 16632,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/scenery-contents.storyarc": 17276,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/nautical.storyarc": 17088,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    ...
    "brass-lantern.storyarc": 17756,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "cloak-of-darkness.storyarc": 18728,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "ejemplo-espanol.storyarc": 21644,  # 2026-07-18 bold banner and location titles (Stefan's polish ruling; four style ops)
    "features/computed-properties.storyarc": 16332,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/containers.storyarc": 16628,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/daemons-and-timers.storyarc": 16648,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/doors-and-locks.storyarc": 16220,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/appearance.storyarc": 17020,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/components.storyarc": 16496,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/perform.storyarc": 16496,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/grains.storyarc": 16376,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/handlers.storyarc": 17448,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/grammar.storyarc": 16640,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/introproperty.storyarc": 17564,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/kinds-and-inheritance.storyarc": 16196,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/on-other.storyarc": 16180,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/zcolor.storyarc": 16568,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/scoring.storyarc": 18548,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/spans.storyarc": 16372,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "features/vehicles.storyarc": 16904,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/ambience.storyarc": 18340,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/conversations.storyarc": 17972,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/extended-verbs.storyarc": 19052,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/infocom-interrogation.storyarc": 18376,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/quotes.storyarc": 16572,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/take-all.storyarc": 18292,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/plurals.storyarc": 17228,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/statusline.storyarc": 16300,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
    "granules/verbose-exits.storyarc": 16568,  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
}
...
CLOAK_Z8_CEILING = 19272  # 2026-07-19 STAND is standard too (exit / stand up / stand on; Stefan's go)
