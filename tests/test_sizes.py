...
CEILINGS = {
    ...
    "features/press-any-key.storyarc": 17812,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/consult-about.storyarc": 17812,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/vary.storyarc": 18592,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/beyond.storyarc": 19292,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "beispiel-deutsch.storyarc": 23844,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/doors-and-locks.storyarc": 16976,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/components.storyarc": 17240,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/pathfinding.storyarc": 19368,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/handlers.storyarc": 18176,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/kinds-and-inheritance.storyarc": 17056,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/on-other.storyarc": 16956,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/zcolor.storyarc": 17324,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "features/spans.storyarc": 17180,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/vehicles.storyarc": 17604,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "granules/ambience.storyarc": 18928,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "granules/conversations.storyarc": 18632,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "granules/extended-verbs.storyarc": 19948,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    ...
    "granules/statusline.storyarc": 17060,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
