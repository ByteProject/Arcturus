...
CEILINGS = {
    ...
    "features/foresight.storyarc": 19960,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/beyond.storyarc": 20836,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/alter.storyarc": 19432,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/catalogs.storyarc": 19372,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/matrix.storyarc": 19728,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/direction-grammar.storyarc": 18768,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/scenery-contents.storyarc": 19292,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/nautical.storyarc": 19228,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    ...
    "beispiel-deutsch.storyarc": 24956,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
    "brass-lantern.storyarc": 20012,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "cloak-of-darkness.storyarc": 21036,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "ejemplo-espanol.storyarc": 23708,  # 2026-07-28 repriced: dual-role grain words (grain_from_chain shared walker; grain games only)
    "features/computed-properties.storyarc": 18468,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/containers.storyarc": 18768,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/daemons-and-timers.storyarc": 20064,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/doors-and-locks.storyarc": 18380,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/appearance.storyarc": 19148,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/components.storyarc": 18572,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/perform.storyarc": 18636,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/grains.storyarc": 18528,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/handlers.storyarc": 19612,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/grammar.storyarc": 18760,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/introproperty.storyarc": 19696,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/kinds-and-inheritance.storyarc": 18432,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/on-other.storyarc": 18316,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/zcolor.storyarc": 18708,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/scoring.storyarc": 20684,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/spans.storyarc": 18500,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "features/vehicles.storyarc": 19044,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/ambience.storyarc": 20480,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/conversations.storyarc": 20136,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/extended-verbs.storyarc": 21420,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/infocom-interrogation.storyarc": 20648,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/quotes.storyarc": 18708,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/take-all.storyarc": 20372,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/plurals.storyarc": 19308,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/statusline.storyarc": 18440,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
    "granules/verbose-exits.storyarc": 18708,  # 2026-07-28 repriced: grammar parity (mount/nudge/continue/sing-with join the core words)
}
