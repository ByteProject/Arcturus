...
CEILINGS = {
    "features/yes-no.storyarc": 16824,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/press-any-key.storyarc": 17444,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/shiftable.storyarc": 16964,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/enhance-redefine.storyarc": 17320,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/consult-about.storyarc": 17444,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/session-verbs.storyarc": 17048,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/vary.storyarc": 18228,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/foresight.storyarc": 18128,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/beyond.storyarc": 18924,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/alter.storyarc": 17616,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/catalogs.storyarc": 17568,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/matrix.storyarc": 17880,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/direction-grammar.storyarc": 17000,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/scenery-contents.storyarc": 17468,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/nautical.storyarc": 17484,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    ...
    "beispiel-deutsch.storyarc": 23000,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "brass-lantern.storyarc": 18140,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "cloak-of-darkness.storyarc": 18976,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "ejemplo-espanol.storyarc": 21716,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/computed-properties.storyarc": 16728,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/containers.storyarc": 17048,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/daemons-and-timers.storyarc": 18276,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/doors-and-locks.storyarc": 16612,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/appearance.storyarc": 17388,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/components.storyarc": 16872,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/perform.storyarc": 16892,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/grains.storyarc": 16780,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/handlers.storyarc": 17808,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/grammar.storyarc": 16992,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/introproperty.storyarc": 17888,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/kinds-and-inheritance.storyarc": 16692,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/on-other.storyarc": 16592,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/zcolor.storyarc": 16956,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/scoring.storyarc": 18816,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "features/spans.storyarc": 16816,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "features/vehicles.storyarc": 17236,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/ambience.storyarc": 18560,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/conversations.storyarc": 18264,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/extended-verbs.storyarc": 19584,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "granules/infocom-interrogation.storyarc": 18744,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
    "granules/quotes.storyarc": 16932,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/take-all.storyarc": 18492,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/plurals.storyarc": 17508,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/statusline.storyarc": 16692,  # 2026-08-01 repriced: the statusline boot latch (no bar paint before the first prompt, the CPC flash fix; a flag, the prompt store, and the reserve branch)
    "granules/verbose-exits.storyarc": 16960,  # 2026-07-30 repriced: the exact-name tie-break (a full-coverage match resolves without asking; both matchers carry the check)
}
