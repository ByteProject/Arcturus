...
CEILINGS = {
    "features/yes-no.storyarc": 17584,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/press-any-key.storyarc": 18432,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/shiftable.storyarc": 17944,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/enhance-redefine.storyarc": 18264,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/consult-about.storyarc": 18420,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/session-verbs.storyarc": 18024,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/vary.storyarc": 19200,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/foresight.storyarc": 19552,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/beyond.storyarc": 19984,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/alter.storyarc": 18676,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/catalogs.storyarc": 18552,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/matrix.storyarc": 18864,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/direction-grammar.storyarc": 17976,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/scenery-contents.storyarc": 18524,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/trigger.storyarc": 17560,
    "features/adjectives.storyarc": 18140,  # 2026-08-15 first pin: the adjective marker showcase (>red, the ZIL match classes; games without the marker stay byte-identical)  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "granules/nautical.storyarc": 18464,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/npcengine.storyarc": 20512,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/maniacswap.storyarc": 18728,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "beispiel-deutsch.storyarc": 26164,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "brass-lantern.storyarc": 19288,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "cloak-of-darkness.storyarc": 20068,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "ejemplo-espanol.storyarc": 22912,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/computed-properties.storyarc": 17644,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/containers.storyarc": 18040,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/daemons-and-timers.storyarc": 19208,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/doors-and-locks.storyarc": 17792,  # 2026-08-17 repriced: the existence form (docs/01 chapter 3); a two-sided door is now present on both sides (~264 bytes of presence walk, the two language examples also pay the 1-byte both-forms marker)
    "features/appearance.storyarc": 18380,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/components.storyarc": 17860,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/whistle.storyarc": 17348,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/pathfinding.storyarc": 20248,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/perform.storyarc": 17652,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/grains.storyarc": 17472,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/handlers.storyarc": 18792,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/grammar.storyarc": 17684,  # 2026-08-14 repriced: the version banner grew a character (Cosmos 1.10)
    "features/introproperty.storyarc": 18952,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/kinds-and-inheritance.storyarc": 17612,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/on-other.storyarc": 17504,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/zcolor.storyarc": 17936,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/scoring.storyarc": 19812,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/spans.storyarc": 17728,  # 2026-08-15 repriced: the adjective sweep (>markers arm the ZIL classes per example)
    "features/vehicles.storyarc": 18284,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "features/text-slot.storyarc": 18660,  # 2026-08-31 repriced: the class refusals (relaxed pass + msg_wrong_class)
    "granules/carryweight.storyarc": 18284,  # 2026-08-30 new: the weight-budget showcase
    "granules/ambience.storyarc": 19540,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/conversations.storyarc": 19248,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/extended-verbs.storyarc": 20612,  # 2026-08-22 repriced: pour/spill bind fill through a reversed prepositional line, and the packs carry the role swap (+44; only games with such a line pay)
    "granules/infocom-interrogation.storyarc": 19428,  # 2026-08-11 repriced: the combined room listing (one sentence for plain items, Cosmos 1.5.0; the adopters' request)
    "granules/quotes.storyarc": 17700,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/take-all.storyarc": 19656,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/plurals.storyarc": 18528,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/statusline.storyarc": 17672,  # 2026-08-20 repriced: the bar paints its left side only when it changed
    "granules/verbose-exits.storyarc": 17648,  # 2026-08-11 repriced: the combined room listing (one sentence for plain items, Cosmos 1.5.0; the adopters' request)
}
...
CLOAK_Z8_CEILING = 20704  # 2026-09-01 repriced: the fused phrase_score (the Varuna finding)
