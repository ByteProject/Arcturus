...
CEILINGS = {
    "features/yes-no.storyarc": 16660,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/press-any-key.storyarc": 17280,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/shiftable.storyarc": 16800,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/enhance-redefine.storyarc": 17156,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/consult-about.storyarc": 17280,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/session-verbs.storyarc": 16884,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/vary.storyarc": 18064,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/foresight.storyarc": 17964,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/beyond.storyarc": 18760,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/alter.storyarc": 17452,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/catalogs.storyarc": 17404,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/matrix.storyarc": 17716,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/direction-grammar.storyarc": 16836,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/scenery-contents.storyarc": 17304,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/nautical.storyarc": 17320,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    ...
    "beispiel-deutsch.storyarc": 22836,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "brass-lantern.storyarc": 17992,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "cloak-of-darkness.storyarc": 18812,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "ejemplo-espanol.storyarc": 21628,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/computed-properties.storyarc": 16580,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/containers.storyarc": 16900,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/daemons-and-timers.storyarc": 18128,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/doors-and-locks.storyarc": 16464,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/appearance.storyarc": 17224,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/components.storyarc": 16708,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/perform.storyarc": 16728,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/grains.storyarc": 16632,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/handlers.storyarc": 17644,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/grammar.storyarc": 16844,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/introproperty.storyarc": 17724,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/kinds-and-inheritance.storyarc": 16544,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/on-other.storyarc": 16444,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/zcolor.storyarc": 16792,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/scoring.storyarc": 18652,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/spans.storyarc": 16668,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "features/vehicles.storyarc": 17072,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/ambience.storyarc": 18396,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/conversations.storyarc": 18100,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/extended-verbs.storyarc": 19260,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/infocom-interrogation.storyarc": 18596,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/quotes.storyarc": 16768,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/take-all.storyarc": 18328,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/plurals.storyarc": 17344,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/statusline.storyarc": 16528,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
    "granules/verbose-exits.storyarc": 16812,  # 2026-07-30 repriced DOWN: the peephole exhaustion (inc/dec, jz, short calls, merged je ladders, discard-only block tails)
}
