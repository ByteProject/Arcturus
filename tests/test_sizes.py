...
CEILINGS = {
    "features/yes-no.storyarc": 18000,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/press-any-key.storyarc": 18892,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/shiftable.storyarc": 18388,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/enhance-redefine.storyarc": 18740,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/consult-about.storyarc": 18856,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/session-verbs.storyarc": 18452,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/vary.storyarc": 19660,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/foresight.storyarc": 20076,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/beyond.storyarc": 20512,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/alter.storyarc": 19140,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/catalogs.storyarc": 19004,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/matrix.storyarc": 19340,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/direction-grammar.storyarc": 18412,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/scenery-contents.storyarc": 19056,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/trigger.storyarc": 18020,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/adjectives.storyarc": 18656,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/nautical.storyarc": 18892,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/npcengine.storyarc": 20984,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/maniacswap.storyarc": 19224,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "beispiel-deutsch.storyarc": 27652,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "brass-lantern.storyarc": 19796,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "cloak-of-darkness.storyarc": 21216,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "ejemplo-espanol.storyarc": 24248,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/computed-properties.storyarc": 18104,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/containers.storyarc": 18596,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/daemons-and-timers.storyarc": 19748,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/doors-and-locks.storyarc": 18236,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/appearance.storyarc": 19064,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/components.storyarc": 18320,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/whistle.storyarc": 17748,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/pathfinding.storyarc": 20740,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/perform.storyarc": 18068,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/grains.storyarc": 17872,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/handlers.storyarc": 19268,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/grammar.storyarc": 18176,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/introproperty.storyarc": 19516,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/kinds-and-inheritance.storyarc": 18068,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/on-other.storyarc": 17948,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/zcolor.storyarc": 18388,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/scoring.storyarc": 20320,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/spans.storyarc": 18188,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/vehicles.storyarc": 18728,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/success.storyarc": 18676,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/edible.storyarc": 18564,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "features/text-slot.storyarc": 19100,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/carryweight.storyarc": 18876,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/ambience.storyarc": 19976,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/conversations.storyarc": 19856,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/extended-verbs.storyarc": 21080,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/infocom-interrogation.storyarc": 19884,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/quotes.storyarc": 18124,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/take-all.storyarc": 20284,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/plurals.storyarc": 19052,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/statusline.storyarc": 18100,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
    "granules/verbose-exits.storyarc": 18048,  # 2026-09-11 repriced: the per-item label is the language layer's (line_item_label)
}
...
CLOAK_Z8_CEILING = 21864  # 2026-09-11 repriced: the per-item label is the language layer's
