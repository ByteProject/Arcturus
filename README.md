...
|-----------|---------|----------|
| **arcc**, the compiler (the Cosmos library is embedded inside it) | 1.3.18 | [build/arcc](build/arcc) |
| **Cosmos**, the standard library | 1.2.17 | shipped inside `arcc` |
| **Actaea**, the reference interpreter | 1.3.3 | [build/actaea](build/actaea) |
