; The outline: rooms, things, kinds, blocks, and topics as symbols, so
; Zed's breadcrumbs and symbol search navigate a story file.
(object_declaration keyword: _ @context name: (identifier) @name) @item
