# The bundled typefaces and their licenses

Actaea ships four typefaces so its three looks render identically on
every machine. All are free software fonts, bundled unmodified, and none
may be sold on their own. This document is the license record the About
dialog links to.

| Face | Files | Author / Foundry | License |
|------|-------|------------------|---------|
...
## SIL Open Font License, Version 1.1 (Noto Serif, Roboto, Roboto Mono)

Copyright: the Noto Project Authors (https://github.com/notofonts/latin-greek-cyrillic),
the Roboto Project Authors (https://github.com/googlefonts/roboto-classic),
and the Roboto Mono Project Authors (https://github.com/googlefonts/robotomono).

This Font Software is licensed under the SIL Open Font License,
Version 1.1, available with a FAQ at https://openfontlicense.org.
...
## CC0 1.0 Universal (monogram extended)

monogram, by datagoblin, is dedicated to the public domain under the
Creative Commons Zero 1.0 Universal dedication:
