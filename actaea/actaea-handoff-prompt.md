# Actaea continuation prompt (Arcturus milestone B7)
...
We are starting Arcturus milestone B7: Actaea, the reference Z-machine
...
- arc_image is not part of Actaea. It is later work, milestones B8 and B9, in
